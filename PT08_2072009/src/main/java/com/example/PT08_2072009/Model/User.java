package com.example.PT08_2072009.Model;
...
public class User {
    ...
    private Collection<Watchlist> watchlistsByIdUser;
    ...
    public Collection<Watchlist> getWatchlistsByIdUser() {
        return watchlistsByIdUser;
    }

    public void setWatchlistsByIdUser(Collection<Watchlist> watchlistsByIdUser) {
